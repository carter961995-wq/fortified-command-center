  ...
  return (
    <main className="industrial-grid flex min-h-screen items-center justify-center bg-stone-950 p-4">
      <section className="w-full max-w-md rounded-3xl border border-stone-800 bg-white p-8 shadow-2xl">
        ...
        <h1 className="mt-3 text-3xl font-black text-stone-950">Fortified Command Center</h1>
        <p className="mt-2 text-sm leading-6 text-stone-600">Sign in, then connect Gmail or a dispatch portal. The Command Center pulls current work orders and sorts bid / quote mail automatically.</p>
